...
class Pelicula extends Model {
  ...
  public function delete() {
    ...
    if (!isset($this->id)) {
      throw new Exception("¿Estas seguro que estas utilizando la función find?");
    }
    
    if ($this->id !== $id) {
      throw new Exception("No estas eliminando la misma película que recibis en el formulario");
    }
  }
}
